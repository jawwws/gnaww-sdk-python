...
conf = gnaww_sdk.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.gnaww.io" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("gnaww_sdk")
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        """
        auth: AuthSettings = {}
        if 'GnawwApiKey' in self.api_key:
            auth['GnawwApiKey'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-Gnaww-API-Key',
