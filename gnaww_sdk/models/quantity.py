...
class Quantity(BaseModel):
    ...
    variable_data: Optional[StrictBool] = False
    __properties: ClassVar[List[str]] = ["units", "variable_data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "units": obj.get("units"),
            "variable_data": obj.get("variable_data") if obj.get("variable_data") is not None else False
        })
        return _obj
