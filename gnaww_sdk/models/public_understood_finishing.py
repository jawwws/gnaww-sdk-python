...
class PublicUnderstoodFinishing(BaseModel):
    """
    One controlled finishing fact established without claiming complete geometry.
    """ # noqa: E501
    category: StrictStr
    geometry_complete: Optional[StrictBool] = False
    name: Annotated[str, Field(min_length=1, strict=True)]
    process: Optional[StrictStr] = None
    source_expression: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["category", "geometry_complete", "name", "process", "source_expression"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicUnderstoodFinishing from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicUnderstoodFinishing from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "geometry_complete": obj.get("geometry_complete") if obj.get("geometry_complete") is not None else False,
            "name": obj.get("name"),
