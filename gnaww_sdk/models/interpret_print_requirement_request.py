...
class InterpretPrintRequirementRequest(BaseModel):
    """
    Developer-facing request for the preferred interpretation boundary.
    """ # noqa: E501
    gjs_version: Optional[StrictStr] = '0.4'
    schema_name: Optional[StrictStr] = 'gnaww.interpretation_request'
    schema_version: Optional[StrictStr] = '0.1'
    source: SourceInput
    __properties: ClassVar[List[str]] = ["gjs_version", "schema_name", "schema_version", "source"]
    ...
    def schema_name_validate_enum(cls, value):
        ...
        if value not in set(['gnaww.interpretation_request']):
            raise ValueError("must be one of enum values ('gnaww.interpretation_request')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InterpretPrintRequirementRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InterpretPrintRequirementRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "schema_name": obj.get("schema_name") if obj.get("schema_name") is not None else 'gnaww.interpretation_request',
