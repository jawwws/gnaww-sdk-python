...
class QuantityRange(BaseModel):
    ...
    """ # noqa: E501
    increments: Optional[List[StrictInt]] = None
    maximum: Optional[Annotated[int, Field(strict=True, gt=0)]] = None
    minimum: Optional[Annotated[int, Field(strict=True, gt=0)]] = None
    step: Optional[Annotated[int, Field(strict=True, gt=0)]] = None
    __properties: ClassVar[List[str]] = ["increments", "maximum", "minimum", "step"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QuantityRange from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QuantityRange from a dict"""
        if obj is None:
            return None
