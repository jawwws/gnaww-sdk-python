...
class PublicMatchTargetRequest(BaseModel):
    """
    ...
    source: StrictStr
    __properties: ClassVar[List[str]] = ["producer_profile_id", "source"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicMatchTargetRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicMatchTargetRequest from a dict"""
        if obj is None:
            return None
