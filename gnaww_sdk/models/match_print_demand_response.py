...
class MatchPrintDemandResponse(BaseModel):
    """
    ...
    schema_name: Optional[StrictStr] = 'gnaww.specmatch_result'
    ...
    def schema_name_validate_enum(cls, value):
        ...
        if value not in set(['gnaww.specmatch_result']):
            raise ValueError("must be one of enum values ('gnaww.specmatch_result')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MatchPrintDemandResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MatchPrintDemandResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "schema_name": obj.get("schema_name") if obj.get("schema_name") is not None else 'gnaww.specmatch_result',
