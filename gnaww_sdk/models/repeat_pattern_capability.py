...
class RepeatPatternCapability(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["maximum_height_mm", "maximum_width_mm", "types"]
    ...
    def types_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['none', 'straight', 'half_drop', 'mirror', 'seamless', 'engineered', 'unknown']):
                raise ValueError("each list item must be one of ('none', 'straight', 'half_drop', 'mirror', 'seamless', 'engineered', 'unknown')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RepeatPatternCapability from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RepeatPatternCapability from a dict"""
        if obj is None:
            return None
