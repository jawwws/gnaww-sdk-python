...
class Line2D(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Line2D from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Line2D from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "end": Point2D.from_dict(obj["end"]) if obj.get("end") is not None else None,
            "kind": obj.get("kind") if obj.get("kind") is not None else 'line',
            "start": Point2D.from_dict(obj["start"]) if obj.get("start") is not None else None
        })
        return _obj
