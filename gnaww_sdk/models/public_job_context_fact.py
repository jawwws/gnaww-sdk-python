...
class PublicJobContextFact(BaseModel):
    """
    One provenance-aware source fact scoped to a single Job.
    """ # noqa: E501
    fact_id: Annotated[str, Field(strict=True)]
    ...
    __properties: ClassVar[List[str]] = ["fact_id", "key", "posture", "provenance", "requires_confirmation", "source_expression", "value"]

    @field_validator('fact_id')
    def fact_id_validate_regular_expression(cls, value):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicJobContextFact from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicJobContextFact from a dict"""
        if obj is None:
            return None
