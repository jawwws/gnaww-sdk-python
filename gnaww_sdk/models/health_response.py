...
class HealthResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["environment", "service", "status", "version"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['ok', 'not_ready']):
            raise ValueError("must be one of enum values ('ok', 'not_ready')")
        return value
