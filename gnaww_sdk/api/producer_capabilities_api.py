...
class ProducerCapabilitiesApi:
    ...
    @validate_call
    def get_producer_capability_profile(
        self,
        profile_id: StrictStr,
        source: Annotated[Optional[StrictStr], Field(description="Capability source used by the corresponding SpecMatch target.")] = None,
        ...
        :type profile_id: str
        :param source: Capability source used by the corresponding SpecMatch target.
        :type source: str
        ...
        _param = self._get_producer_capability_profile_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ProducerCapabilityResource",
        }
    ...
    @validate_call
    def get_producer_capability_profile_with_http_info(
        self,
        profile_id: StrictStr,
        source: Annotated[Optional[StrictStr], Field(description="Capability source used by the corresponding SpecMatch target.")] = None,
        x_gnaww_workspace_id: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProducerCapabilityResource]:
        """Get Producer Capability Profile
    ...
    @validate_call
    def get_producer_capability_profile_without_preload_content(
        self,
        profile_id: StrictStr,
        source: Annotated[Optional[StrictStr], Field(description="Capability source used by the corresponding SpecMatch target.")] = None,
        x_gnaww_workspace_id: Optional[StrictStr] = None,
    ...
    def _get_producer_capability_profile_serialize(
        self,
        profile_id,
        source,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/producer-capabilities/{profile_id}',
