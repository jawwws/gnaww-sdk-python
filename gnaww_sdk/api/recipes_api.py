...
class RecipesApi:
    ...
    def _get_recipe_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/recipes/{recipe_id}',
    ...
    def match_recipe(
        self,
        recipe_id: StrictStr,
        match_recipe_request: MatchRecipeRequest,
        x_gnaww_workspace_id: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param recipe_id: (required)
        :type recipe_id: str
        :param match_recipe_request: (required)
        :type match_recipe_request: MatchRecipeRequest
        :param x_gnaww_workspace_id:
        :type x_gnaww_workspace_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._match_recipe_serialize(
            recipe_id=recipe_id,
            match_recipe_request=match_recipe_request,
            x_gnaww_workspace_id=x_gnaww_workspace_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def match_recipe_with_http_info(
        self,
        recipe_id: StrictStr,
        match_recipe_request: MatchRecipeRequest,
        x_gnaww_workspace_id: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MatchRecipeResponse]:
        """Match Recipe
    ...
    @validate_call
    def match_recipe_without_preload_content(
        self,
        recipe_id: StrictStr,
        match_recipe_request: MatchRecipeRequest,
        x_gnaww_workspace_id: Optional[StrictStr] = None,
    ...
    def _match_recipe_serialize(
        self,
        recipe_id,
        match_recipe_request,
        x_gnaww_workspace_id,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if match_recipe_request is not None:
            _body_params = match_recipe_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/recipes/{recipe_id}/matches',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def resolve_recipe(
        self,
        resolve_recipe_request: ResolveRecipeRequest,
        x_gnaww_workspace_id: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param resolve_recipe_request: (required)
        :type resolve_recipe_request: ResolveRecipeRequest
        :param x_gnaww_workspace_id:
        :type x_gnaww_workspace_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._resolve_recipe_serialize(
            resolve_recipe_request=resolve_recipe_request,
            x_gnaww_workspace_id=x_gnaww_workspace_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def resolve_recipe_with_http_info(
        self,
        resolve_recipe_request: ResolveRecipeRequest,
        x_gnaww_workspace_id: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResolveRecipeResponse]:
        """Resolve Recipe
    ...
    @validate_call
    def resolve_recipe_without_preload_content(
        self,
        resolve_recipe_request: ResolveRecipeRequest,
        x_gnaww_workspace_id: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _resolve_recipe_serialize(
        self,
        resolve_recipe_request,
        x_gnaww_workspace_id,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if resolve_recipe_request is not None:
            _body_params = resolve_recipe_request
