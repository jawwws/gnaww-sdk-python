...
class TransformApi:
    ...
    @validate_call
    def transform_print_requirement(
        self,
        ...
        :param transform_request: (required)
        :type transform_request: TransformRequest
        ...
        _param = self._transform_print_requirement_serialize(
    ...
    @validate_call
    def transform_print_requirement_with_http_info(
        self,
        transform_request: TransformRequest,
        x_gnaww_workspace_id: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def transform_print_requirement_without_preload_content(
        self,
        transform_request: TransformRequest,
        x_gnaww_workspace_id: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _transform_print_requirement_serialize(
        self,
        transform_request,
        ...
        if transform_request is not None:
            _body_params = transform_request
