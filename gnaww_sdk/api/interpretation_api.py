...
class InterpretationApi:
    ...
    def continue_print_requirement_interpretation(
        self,
        continue_print_requirement_request: ContinuePrintRequirementRequest,
        ...
        :param continue_print_requirement_request: (required)
        :type continue_print_requirement_request: ContinuePrintRequirementRequest
        ...
        _param = self._continue_print_requirement_interpretation_serialize(
            continue_print_requirement_request=continue_print_requirement_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ContinuePrintRequirementResponse",
        }
    ...
    def continue_print_requirement_interpretation_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ContinuePrintRequirementResponse]:
        """Continue Print Requirement Interpretation
    ...
    def _continue_print_requirement_interpretation_serialize(
        self,
        continue_print_requirement_request,
        ...
        if continue_print_requirement_request is not None:
            _body_params = continue_print_requirement_request
    ...
    def interpret_print_requirement(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "InterpretPrintRequirementResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def interpret_print_requirement_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[InterpretPrintRequirementResponse]:
        """Interpret Print Requirement
