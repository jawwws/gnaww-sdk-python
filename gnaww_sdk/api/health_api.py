...
class HealthApi:
    ...
    def get_api_liveness(
        ...
        _param = self._get_api_liveness_serialize(
    ...
    @validate_call
    def get_api_liveness_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_api_liveness_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_api_liveness_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def get_api_readiness(
        ...
        _param = self._get_api_readiness_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_api_readiness_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_api_readiness_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_api_readiness_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
